...
export default (http, saveJWTToken, getUserId, onLogout = () => {}) => ({
	...
	getPhonelineBlockAnonymous: phonelineId => (http.get(`/${getUserId()}/phonelines/${phonelineId}/blockanonymous`)),
	setPhonelineBlockAnonymous: (phonelineId, enabled, target) => (http.put(`/${getUserId()}/phonelines/${phonelineId}/blockanonymous`, { enabled, target })),
	...
	createVoicemailEmailNotification: (voicemailId, email) => http.post(`/${getUserId()}/notifications/voicemail/email`, { voicemailId, email }),
